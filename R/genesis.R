...
#' @param M total number of SNPs in the reference panel; by default, it is the total number of common SNPs in Hapmap3 reference panel, i.e., 953834.
...
genesis <- function(summarydata, filter=FALSE,
                    modelcomponents=2, cores=10, LDcutoff=0.1, LDwindow=1, M=953834,
                    c0=10, BIC.gamma=0.5, 
